          ...
          <div className="p-8">
            ...
            <div className="flex items-start gap-6 mb-6 pb-6 border-b-2 border-gray-200">
              ...
              <div className="grid md:grid-cols-2 gap-4 flex-1">
                <div>
                  ...
                  <p className="text-[#0A2540]">Fatima Abubakar Mohammed</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Student ID</p>
                  <p className="text-[#0A2540]">GRA/2024/0045</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Class</p>
                  <p className="text-[#0A2540]">JSS 2A</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Session</p>
                  <p className="text-[#0A2540]">2024/2025</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Term</p>
                  <p className="text-[#0A2540]">Second Term</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Number in Class</p>
                  <p className="text-[#0A2540]">45</p>
                </div>
              </div>
            </div>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    ...
                    <tr className="bg-[#0A2540] text-white">
                      ...
                      <td className="p-3 text-center" colSpan={2}>Average: 82.2%</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="p-4 bg-[#FFD700]/10 border-2 border-[#FFD700] rounded-xl text-center">
                ...
                <p className="text-2xl text-[#0A2540]">5th/45</p>
              </div>
              ...
              <div className="p-4 bg-blue-50 border-2 border-blue-200 rounded-xl text-center">
                ...
                <p className="text-2xl text-blue-700">82.2%</p>
              </div>
            </div>
