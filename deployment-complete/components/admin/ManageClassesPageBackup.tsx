...
function ManageClassesPageDesktop() {
  ...
  const handleEditClass = async () => {
    ...
    try {
      const success = await updateClass(selectedClass.id, updatedClass);
      if (success) {
    ...
    <div className="p-6 space-y-6">
      {viewMode === 'grid' ? (
        <>
          ...
          {/* Inline Form (for creating/editing classes) - MOVED HERE */}
          {showForm && (
            <>
              {console.log('=== FORM RENDERING ===', { showForm, viewMode })}
              <Card className="border-[#0A2540]/10 shadow-lg mb-6">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select 
                        ...
                        onValueChange={(value) => setFormData({...formData, category: value as "Primary" | "Secondary"})}
                      >
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label className="text-[#0A2540]">Class Capacity *</Label>
                      <Input
                        type="number"
